...
public class MemberAccess extends AST{
    public static List<MemberAccess> registry = new ArrayList<MemberAccess>();
    ...
    public MemberAccess(JSONObject node, String type) {
        nodeType = "Identifier";
        registry.add(this);
    ...
    public static List<MemberAccess> getRegistry() {
        return registry;
    }
